                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="btn btn-raised btn-primary btn-round waves-effect" onclick='document.location.href="${pageContext.request.contextPath}/CheckOutController"' type="button" value="CheckOut"/>
